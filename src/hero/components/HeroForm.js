  ...
  <form onSubmit={handleSubmit}>
    ...
    <div className='hero-trait-options'>
      ...
      <div className='hero-alignment container'>
        ...
        <div className="row">
          <lable className="col-4">Lawful Good
            <input
              type="radio"
              name="alignment"
          ...
          <lable className="col-4">Neutral Good
            <input
              type="radio"
              name="alignment"
          ...
          <lable className="col-4">Chaotic Good
            <input
              type="radio"
              name="alignment"
        ...
        <div className="row">
          <lable className="col-4">Lawful Neutral
            <input
              type="radio"
              name="alignment"
          ...
          <lable className="col-4">True Neutral
            <input
              type="radio"
              name="alignment"
          ...
          <lable className="col-4">Chaotic Neutral
            <input
              type="radio"
              name="alignment"
        ...
        <div className="row">
          <lable className="col-4">Lawful Evil
            <input
              type="radio"
              name="alignment"
          ...
          <lable className="col-4">Neutral Evil
            <input
              type="radio"
              name="alignment"
          ...
          <lable className="col-4">Chaotic Evil
            <input
              type="radio"
              name="alignment"
    ...
    <div className='hero-kin-options container'>
      ...
      <div className="row">
        ...
        <lable className="col-4">Halfling
          <input
            type="radio"
            name="kin"
      ...
      <div className="row">
        ...
        <lable className="col-4">Dragonborn
          <input
            type="radio"
            name="kin"
      ...
      <div className="row">
        <lable className="col-4">Half-Elf
          <input
            type="radio"
            name="kin"
        ...
        <lable className="col-4">Half-Orc
          <input
            type="radio"
            name="kin"
        ...
        <lable className="col-4">Tiefling
          <input
            type="radio"
            name="kin"
    ...
    <div className='hero-specialty-options container'>
      <h3>Select Class</h3>
      <div className="row">
        <lable className="col-4">Barbarian
          <input
            type="radio"
            name="specialty"
      ...
      <div className="row">
        <lable className="col-4">Sorcerer
          <input
            type="radio"
            name="specialty"
